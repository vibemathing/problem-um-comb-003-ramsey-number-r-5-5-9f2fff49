...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-comb-003-ramsey-number-r-5-5-9f2fff49-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/COMB-003"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-comb-003-ramsey-number-r-5-5-9f2fff49-v1",
      "problem_contract_sha256": "2b6e1cc65abcca34329b03d4971f3d3ec9d6302de092dd609d55587dede21873",
      "problem_id": "problem:um-comb-003-ramsey-number-r-5-5-9f2fff49",
      "route_id": "route:um-comb-003-ramsey-number-r-5-5-9f2fff49-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-comb-003-ramsey-number-r-5-5-9f2fff49-source-fidelity-01",
      "graph_id": "graph:um-comb-003-ramsey-number-r-5-5-9f2fff49-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-comb-003-ramsey-number-r-5-5-9f2fff49-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-comb-003-ramsey-number-r-5-5-9f2fff49-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the exact value of $R(5,5)$, the smallest number $n$ such that any 2-coloring of the edges of $K_n$ contains a monochromatic $K_5$?"
          },
          "statement_sha256": "2f0edf196372250f7a90ccf9748a66e8aa51197e350eb9cd5aa02c481cc2cfe9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-comb-003-ramsey-number-r-5-5-9f2fff49-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-comb-003-ramsey-number-r-5-5-9f2fff49-root",
      "route_id": "route:um-comb-003-ramsey-number-r-5-5-9f2fff49-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-comb-003-1000fbdde3c4",
        "url": "https://www.unsolvedmath.com/problems/COMB-003"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
